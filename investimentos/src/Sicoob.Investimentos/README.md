...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/investimentos.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{33C1BF81-901E-4579-83A1-0FC3C778D3D9}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAplicaoApi>();
            IRendaFixaAportesPostApiResponse apiResponse = await api.RendaFixaAportesPostAsync("todo");
            RendaFixaResgatesPost200Response? model = apiResponse.Ok();
        }
...
- appVersion: 1.0.3.3
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/investimentos/v2 ]&lt;/pre&gt; API dedicada a retornar os investimentos de um determinado cliente em várias etapas. Primeira a partir apenas do CPF, depois por carteira e por fim por modalidade
