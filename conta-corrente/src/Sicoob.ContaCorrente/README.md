...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/conta-corrente.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{8C1FAEEB-18F1-4D96-A04E-560B92291E14}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IExtratoApi>();
            IObterExtratoCompletoApiResponse apiResponse = await api.ObterExtratoCompletoAsync("todo");
            ExtratoSpuOpenBankingRestDTO? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Conta Corrente
- appVersion: 2.1.1.43
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/conta-corrente/v4 ]&lt;/pre&gt;  # Conta Corrente API A API de Contas Correntes permite o acesso a dados de conta corrente como Saldo e Extrato. 
