...
> CobVPayload CobvpixUrlAccessTokenGet (string cobvpixUrlAccessToken, string codMun = null, DateOnly DPP = null)
...
| **DPP** | **DateOnly** | Data de pagamento pretendida. Trata-se de uma data, no formato &#x60;YYYY-MM-DD&#x60;, segundo ISO 8601. | [optional]  |
...
> CobPayload PixUrlAccessTokenGet (string pixUrlAccessToken)
