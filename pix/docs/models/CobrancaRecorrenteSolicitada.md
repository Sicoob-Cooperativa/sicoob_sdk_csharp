# Sicoob.Pix.Model.CobrancaRecorrenteSolicitada
...
**AjusteDiaUtil** | **bool** | Campo de ativação do ajuste da data prevista para liquidação para próximo dia útil caso o vencimento corrente seja um dia não útil. O PSP Recebedor deverá considerar os feriados locais com base no código município do usuário pagador. | [optional] [default to true]
