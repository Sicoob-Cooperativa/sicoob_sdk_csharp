...
namespace Sicoob.Pix.Model
{
    ...
    /// </summary>
    public partial class InformaEsDeRetirada1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InformaEsDeRetirada1" /> class.
        /// </summary>
        /// <param name="informaEsDeRetirada1OneOf"></param>
        public InformaEsDeRetirada1(InformaEsDeRetirada1OneOf informaEsDeRetirada1OneOf)
        {
            InformaEsDeRetirada1OneOf = informaEsDeRetirada1OneOf;
            OnCreated();
        }
        ...
        /// Initializes a new instance of the <see cref="InformaEsDeRetirada1" /> class.
        /// </summary>
        /// <param name="informaEsDeRetirada1OneOf1"></param>
        public InformaEsDeRetirada1(InformaEsDeRetirada1OneOf1 informaEsDeRetirada1OneOf1)
        {
            InformaEsDeRetirada1OneOf1 = informaEsDeRetirada1OneOf1;
            OnCreated();
        }
        ...
        /// <summary>
        /// Gets or Sets InformaEsDeRetirada1OneOf
        /// </summary>
        public InformaEsDeRetirada1OneOf? InformaEsDeRetirada1OneOf { get; set; }

        /// <summary>
        /// Gets or Sets InformaEsDeRetirada1OneOf1
        /// </summary>
        public InformaEsDeRetirada1OneOf1? InformaEsDeRetirada1OneOf1 { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InformaEsDeRetirada1 {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="InformaEsDeRetirada1" />
    /// </summary>
    public class InformaEsDeRetirada1JsonConverter : JsonConverter<InformaEsDeRetirada1>
    {
        /// <summary>
        /// Deserializes json to <see cref="InformaEsDeRetirada1" />
        /// </summary>
        ...
        public override InformaEsDeRetirada1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            InformaEsDeRetirada1OneOf? informaEsDeRetirada1OneOf = default;
            InformaEsDeRetirada1OneOf1? informaEsDeRetirada1OneOf1 = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderInformaEsDeRetirada1OneOf = utf8JsonReader;
                    ClientUtils.TryDeserialize<InformaEsDeRetirada1OneOf?>(ref utf8JsonReaderInformaEsDeRetirada1OneOf, jsonSerializerOptions, out informaEsDeRetirada1OneOf);

                    Utf8JsonReader utf8JsonReaderInformaEsDeRetirada1OneOf1 = utf8JsonReader;
                    ClientUtils.TryDeserialize<InformaEsDeRetirada1OneOf1?>(ref utf8JsonReaderInformaEsDeRetirada1OneOf1, jsonSerializerOptions, out informaEsDeRetirada1OneOf1);
                }
            }
            ...
            if (informaEsDeRetirada1OneOf != null)
                return new InformaEsDeRetirada1(informaEsDeRetirada1OneOf);

            if (informaEsDeRetirada1OneOf1 != null)
                return new InformaEsDeRetirada1(informaEsDeRetirada1OneOf1);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="InformaEsDeRetirada1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="informaEsDeRetirada1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InformaEsDeRetirada1 informaEsDeRetirada1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, informaEsDeRetirada1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InformaEsDeRetirada1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="informaEsDeRetirada1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InformaEsDeRetirada1 informaEsDeRetirada1, JsonSerializerOptions jsonSerializerOptions)
        {
