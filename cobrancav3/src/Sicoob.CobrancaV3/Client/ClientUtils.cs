...
[assembly: InternalsVisibleTo("Sicoob.CobrancaV3.Test")]
...
namespace Sicoob.CobrancaV3.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Status.CodigoEnum statusCodigoEnum)
                return Status.CodigoEnumToJsonValue(statusCodigoEnum).ToString();
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.sicoob.com.br/cobranca-bancaria/v3";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/cobranca-bancaria/v3";
