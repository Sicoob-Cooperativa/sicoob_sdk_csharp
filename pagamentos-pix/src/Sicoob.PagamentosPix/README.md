...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/pagamentos-pix.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{D9193C8D-4938-4A5C-897F-8FDABCC14A98}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAPIDePagamentosPIXApi>();
            IPagamentosConfirmacaoPostApiResponse apiResponse = await api.PagamentosConfirmacaoPostAsync("todo");
            RetornoPagamento? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Pagamentos PIX
- appVersion: 2.0.24.6
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/pix-pagamentos/v2 ]&lt;/pre&gt; API de pagamentos.
