...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/cobranca-bancaria-pagamentos.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{987DEA30-331B-4287-96BF-945665E6D117}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IMovimentaesDDAApi>();
            IBoletosGetApiResponse apiResponse = await api.BoletosGetAsync("todo");
            List<BoletoDDA>? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Cobrança Bancária Pagamentos
- appVersion: 3.0.2.0
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/pagamentos/v3 ]&lt;/pre&gt; Esta API disponibiliza funcionalidades para realização de pagamentos de boletos de Cobrança Bancária.
