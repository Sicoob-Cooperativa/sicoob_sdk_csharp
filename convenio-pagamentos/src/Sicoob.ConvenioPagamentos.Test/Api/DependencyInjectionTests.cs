...
namespace Sicoob.ConvenioPagamentos.Test.Api
{
    ...
    public class DependencyInjectionTest
    {
        ...
        {
            var arrecadaoApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IArrecadaoApi>();
            Assert.True(arrecadaoApi.HttpClient.BaseAddress != null);

            var dbitosAutomticosApi = _hostUsingConfigureWithAClient.Services.GetRequiredService<IDbitosAutomticosApi>();
            Assert.True(dbitosAutomticosApi.HttpClient.BaseAddress != null);
        ...
        {
            var arrecadaoApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IArrecadaoApi>();
            Assert.True(arrecadaoApi.HttpClient.BaseAddress != null);

            var dbitosAutomticosApi = _hostUsingConfigureWithoutAClient.Services.GetRequiredService<IDbitosAutomticosApi>();
            Assert.True(dbitosAutomticosApi.HttpClient.BaseAddress != null);
        ...
        {
            var arrecadaoApi = _hostUsingAddWithAClient.Services.GetRequiredService<IArrecadaoApi>();
            Assert.True(arrecadaoApi.HttpClient.BaseAddress != null);
            
            var dbitosAutomticosApi = _hostUsingAddWithAClient.Services.GetRequiredService<IDbitosAutomticosApi>();
            Assert.True(dbitosAutomticosApi.HttpClient.BaseAddress != null);
        ...
        {
            var arrecadaoApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IArrecadaoApi>();
            Assert.True(arrecadaoApi.HttpClient.BaseAddress != null);

            var dbitosAutomticosApi = _hostUsingAddWithoutAClient.Services.GetRequiredService<IDbitosAutomticosApi>();
            Assert.True(dbitosAutomticosApi.HttpClient.BaseAddress != null);
