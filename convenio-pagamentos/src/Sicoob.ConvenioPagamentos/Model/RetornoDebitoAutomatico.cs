...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// </summary>
    public partial class RetornoDebitoAutomatico : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetornoDebitoAutomatico" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public RetornoDebitoAutomatico(Option<RetornoDebitoAutomaticoResultado?> resultado = default)
        {
        ...
        public Option<RetornoDebitoAutomaticoResultado?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public RetornoDebitoAutomaticoResultado? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="RetornoDebitoAutomatico" />
    /// </summary>
    public class RetornoDebitoAutomaticoJsonConverter : JsonConverter<RetornoDebitoAutomatico>
    {
        /// <summary>
        /// Deserializes json to <see cref="RetornoDebitoAutomatico" />
        /// </summary>
        ...
        public override RetornoDebitoAutomatico Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RetornoDebitoAutomaticoResultado?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<RetornoDebitoAutomaticoResultado?>(JsonSerializer.Deserialize<RetornoDebitoAutomaticoResultado>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class RetornoDebitoAutomatico.");

            return new RetornoDebitoAutomatico(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="RetornoDebitoAutomatico" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoDebitoAutomatico"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RetornoDebitoAutomatico retornoDebitoAutomatico, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, retornoDebitoAutomatico, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RetornoDebitoAutomatico" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoDebitoAutomatico"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RetornoDebitoAutomatico retornoDebitoAutomatico, JsonSerializerOptions jsonSerializerOptions)
        {
            if (retornoDebitoAutomatico.ResultadoOption.IsSet && retornoDebitoAutomatico.Resultado == null)
                throw new ArgumentNullException(nameof(retornoDebitoAutomatico.Resultado), "Property is required for class RetornoDebitoAutomatico.");

            if (retornoDebitoAutomatico.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, retornoDebitoAutomatico.Resultado, jsonSerializerOptions);
            }
        }
    }
}
