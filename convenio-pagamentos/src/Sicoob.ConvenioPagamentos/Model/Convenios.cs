...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// Convenios
    /// </summary>
    public partial class Convenios : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Convenios" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public Convenios(Option<List<ConveniosResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<ConveniosResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<ConveniosResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Convenios" />
    /// </summary>
    public class ConveniosJsonConverter : JsonConverter<Convenios>
    {
        /// <summary>
        /// Deserializes json to <see cref="Convenios" />
        /// </summary>
        ...
        public override Convenios Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ConveniosResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<ConveniosResultadoInner>?>(JsonSerializer.Deserialize<List<ConveniosResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class Convenios.");

            return new Convenios(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="Convenios" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="convenios"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Convenios convenios, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, convenios, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Convenios" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="convenios"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Convenios convenios, JsonSerializerOptions jsonSerializerOptions)
        {
            if (convenios.ResultadoOption.IsSet && convenios.Resultado == null)
                throw new ArgumentNullException(nameof(convenios.Resultado), "Property is required for class Convenios.");

            if (convenios.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, convenios.Resultado, jsonSerializerOptions);
            }
        }
    }
}
