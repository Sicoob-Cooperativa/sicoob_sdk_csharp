...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// Historico
    /// </summary>
    public partial class Historico : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public Historico(Option<HistoricoResultado?> resultado = default)
        {
        ...
        public Option<HistoricoResultado?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public HistoricoResultado? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Historico" />
    /// </summary>
    public class HistoricoJsonConverter : JsonConverter<Historico>
    {
        /// <summary>
        /// Deserializes json to <see cref="Historico" />
        /// </summary>
        ...
        public override Historico Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<HistoricoResultado?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<HistoricoResultado?>(JsonSerializer.Deserialize<HistoricoResultado>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class Historico.");

            return new Historico(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="Historico" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="historico"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Historico historico, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, historico, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Historico" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="historico"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Historico historico, JsonSerializerOptions jsonSerializerOptions)
        {
            if (historico.ResultadoOption.IsSet && historico.Resultado == null)
                throw new ArgumentNullException(nameof(historico.Resultado), "Property is required for class Historico.");

            if (historico.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, historico.Resultado, jsonSerializerOptions);
            }
        }
    }
}
