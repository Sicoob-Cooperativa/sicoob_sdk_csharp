...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// </summary>
    public partial class RetornoDebitoAutomaticoLote : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetornoDebitoAutomaticoLote" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public RetornoDebitoAutomaticoLote(Option<List<RetornoDebitoAutomaticoLoteResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<RetornoDebitoAutomaticoLoteResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<RetornoDebitoAutomaticoLoteResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="RetornoDebitoAutomaticoLote" />
    /// </summary>
    public class RetornoDebitoAutomaticoLoteJsonConverter : JsonConverter<RetornoDebitoAutomaticoLote>
    {
        /// <summary>
        /// Deserializes json to <see cref="RetornoDebitoAutomaticoLote" />
        /// </summary>
        ...
        public override RetornoDebitoAutomaticoLote Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<RetornoDebitoAutomaticoLoteResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<RetornoDebitoAutomaticoLoteResultadoInner>?>(JsonSerializer.Deserialize<List<RetornoDebitoAutomaticoLoteResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class RetornoDebitoAutomaticoLote.");

            return new RetornoDebitoAutomaticoLote(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="RetornoDebitoAutomaticoLote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoDebitoAutomaticoLote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RetornoDebitoAutomaticoLote retornoDebitoAutomaticoLote, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, retornoDebitoAutomaticoLote, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RetornoDebitoAutomaticoLote" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoDebitoAutomaticoLote"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RetornoDebitoAutomaticoLote retornoDebitoAutomaticoLote, JsonSerializerOptions jsonSerializerOptions)
        {
            if (retornoDebitoAutomaticoLote.ResultadoOption.IsSet && retornoDebitoAutomaticoLote.Resultado == null)
                throw new ArgumentNullException(nameof(retornoDebitoAutomaticoLote.Resultado), "Property is required for class RetornoDebitoAutomaticoLote.");

            if (retornoDebitoAutomaticoLote.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, retornoDebitoAutomaticoLote.Resultado, jsonSerializerOptions);
            }
        }
    }
}
