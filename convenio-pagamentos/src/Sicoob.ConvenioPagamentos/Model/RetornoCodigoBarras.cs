...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// RetornoCodigoBarras
    /// </summary>
    public partial class RetornoCodigoBarras : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetornoCodigoBarras" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public RetornoCodigoBarras(Option<List<RetornoCodigoBarrasResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<RetornoCodigoBarrasResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<RetornoCodigoBarrasResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="RetornoCodigoBarras" />
    /// </summary>
    public class RetornoCodigoBarrasJsonConverter : JsonConverter<RetornoCodigoBarras>
    {
        /// <summary>
        /// Deserializes json to <see cref="RetornoCodigoBarras" />
        /// </summary>
        ...
        public override RetornoCodigoBarras Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<RetornoCodigoBarrasResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<RetornoCodigoBarrasResultadoInner>?>(JsonSerializer.Deserialize<List<RetornoCodigoBarrasResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class RetornoCodigoBarras.");

            return new RetornoCodigoBarras(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="RetornoCodigoBarras" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoCodigoBarras"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RetornoCodigoBarras retornoCodigoBarras, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, retornoCodigoBarras, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RetornoCodigoBarras" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoCodigoBarras"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RetornoCodigoBarras retornoCodigoBarras, JsonSerializerOptions jsonSerializerOptions)
        {
            if (retornoCodigoBarras.ResultadoOption.IsSet && retornoCodigoBarras.Resultado == null)
                throw new ArgumentNullException(nameof(retornoCodigoBarras.Resultado), "Property is required for class RetornoCodigoBarras.");

            if (retornoCodigoBarras.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, retornoCodigoBarras.Resultado, jsonSerializerOptions);
            }
        }
    }
}
