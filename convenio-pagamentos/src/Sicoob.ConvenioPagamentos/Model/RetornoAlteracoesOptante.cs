...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// </summary>
    public partial class RetornoAlteracoesOptante : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetornoAlteracoesOptante" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public RetornoAlteracoesOptante(Option<List<RetornoAlteracoesOptanteResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<RetornoAlteracoesOptanteResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<RetornoAlteracoesOptanteResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="RetornoAlteracoesOptante" />
    /// </summary>
    public class RetornoAlteracoesOptanteJsonConverter : JsonConverter<RetornoAlteracoesOptante>
    {
        /// <summary>
        /// Deserializes json to <see cref="RetornoAlteracoesOptante" />
        /// </summary>
        ...
        public override RetornoAlteracoesOptante Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<RetornoAlteracoesOptanteResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<RetornoAlteracoesOptanteResultadoInner>?>(JsonSerializer.Deserialize<List<RetornoAlteracoesOptanteResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class RetornoAlteracoesOptante.");

            return new RetornoAlteracoesOptante(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="RetornoAlteracoesOptante" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoAlteracoesOptante"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RetornoAlteracoesOptante retornoAlteracoesOptante, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, retornoAlteracoesOptante, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RetornoAlteracoesOptante" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retornoAlteracoesOptante"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RetornoAlteracoesOptante retornoAlteracoesOptante, JsonSerializerOptions jsonSerializerOptions)
        {
            if (retornoAlteracoesOptante.ResultadoOption.IsSet && retornoAlteracoesOptante.Resultado == null)
                throw new ArgumentNullException(nameof(retornoAlteracoesOptante.Resultado), "Property is required for class RetornoAlteracoesOptante.");

            if (retornoAlteracoesOptante.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, retornoAlteracoesOptante.Resultado, jsonSerializerOptions);
            }
        }
    }
}
