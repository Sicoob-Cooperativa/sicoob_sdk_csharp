...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// DebitosMovimento
    /// </summary>
    public partial class DebitosMovimento : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DebitosMovimento" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public DebitosMovimento(Option<DebitosMovimentoResultado?> resultado = default)
        {
        ...
        public Option<DebitosMovimentoResultado?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public DebitosMovimentoResultado? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DebitosMovimento" />
    /// </summary>
    public class DebitosMovimentoJsonConverter : JsonConverter<DebitosMovimento>
    {
        /// <summary>
        /// Deserializes json to <see cref="DebitosMovimento" />
        /// </summary>
        ...
        public override DebitosMovimento Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DebitosMovimentoResultado?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<DebitosMovimentoResultado?>(JsonSerializer.Deserialize<DebitosMovimentoResultado>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class DebitosMovimento.");

            return new DebitosMovimento(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="DebitosMovimento" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="debitosMovimento"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DebitosMovimento debitosMovimento, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, debitosMovimento, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DebitosMovimento" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="debitosMovimento"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DebitosMovimento debitosMovimento, JsonSerializerOptions jsonSerializerOptions)
        {
            if (debitosMovimento.ResultadoOption.IsSet && debitosMovimento.Resultado == null)
                throw new ArgumentNullException(nameof(debitosMovimento.Resultado), "Property is required for class DebitosMovimento.");

            if (debitosMovimento.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, debitosMovimento.Resultado, jsonSerializerOptions);
            }
        }
    }
}
