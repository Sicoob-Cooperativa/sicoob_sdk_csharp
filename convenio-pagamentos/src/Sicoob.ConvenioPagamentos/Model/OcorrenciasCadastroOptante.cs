...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// </summary>
    public partial class OcorrenciasCadastroOptante : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OcorrenciasCadastroOptante" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public OcorrenciasCadastroOptante(Option<List<OcorrenciasCadastroOptanteResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<OcorrenciasCadastroOptanteResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<OcorrenciasCadastroOptanteResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="OcorrenciasCadastroOptante" />
    /// </summary>
    public class OcorrenciasCadastroOptanteJsonConverter : JsonConverter<OcorrenciasCadastroOptante>
    {
        /// <summary>
        /// Deserializes json to <see cref="OcorrenciasCadastroOptante" />
        /// </summary>
        ...
        public override OcorrenciasCadastroOptante Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<OcorrenciasCadastroOptanteResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<OcorrenciasCadastroOptanteResultadoInner>?>(JsonSerializer.Deserialize<List<OcorrenciasCadastroOptanteResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class OcorrenciasCadastroOptante.");

            return new OcorrenciasCadastroOptante(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="OcorrenciasCadastroOptante" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ocorrenciasCadastroOptante"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OcorrenciasCadastroOptante ocorrenciasCadastroOptante, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, ocorrenciasCadastroOptante, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OcorrenciasCadastroOptante" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ocorrenciasCadastroOptante"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OcorrenciasCadastroOptante ocorrenciasCadastroOptante, JsonSerializerOptions jsonSerializerOptions)
        {
            if (ocorrenciasCadastroOptante.ResultadoOption.IsSet && ocorrenciasCadastroOptante.Resultado == null)
                throw new ArgumentNullException(nameof(ocorrenciasCadastroOptante.Resultado), "Property is required for class OcorrenciasCadastroOptante.");

            if (ocorrenciasCadastroOptante.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, ocorrenciasCadastroOptante.Resultado, jsonSerializerOptions);
            }
        }
    }
}
