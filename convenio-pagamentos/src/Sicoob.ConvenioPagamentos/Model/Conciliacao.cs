...
namespace Sicoob.ConvenioPagamentos.Model
{
    ...
    /// Conciliacao
    /// </summary>
    public partial class Conciliacao : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Conciliacao" /> class.
        /// </summary>
        /// <param name="resultado">resultado</param>
        [JsonConstructor]
        public Conciliacao(Option<List<ConciliacaoResultadoInner>?> resultado = default)
        {
        ...
        public Option<List<ConciliacaoResultadoInner>?> ResultadoOption { get; private set; }

        /// <summary>
        /// Gets or Sets Resultado
        /// </summary>
        [JsonPropertyName("resultado")]
        public List<ConciliacaoResultadoInner>? Resultado { get { return this.ResultadoOption.Value; } set { this.ResultadoOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Conciliacao" />
    /// </summary>
    public class ConciliacaoJsonConverter : JsonConverter<Conciliacao>
    {
        /// <summary>
        /// Deserializes json to <see cref="Conciliacao" />
        /// </summary>
        ...
        public override Conciliacao Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ConciliacaoResultadoInner>?> resultado = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "resultado":
                            resultado = new Option<List<ConciliacaoResultadoInner>?>(JsonSerializer.Deserialize<List<ConciliacaoResultadoInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (resultado.IsSet && resultado.Value == null)
                throw new ArgumentNullException(nameof(resultado), "Property is not nullable for class Conciliacao.");

            return new Conciliacao(resultado);
        }

        /// <summary>
        /// Serializes a <see cref="Conciliacao" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="conciliacao"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Conciliacao conciliacao, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, conciliacao, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Conciliacao" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="conciliacao"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Conciliacao conciliacao, JsonSerializerOptions jsonSerializerOptions)
        {
            if (conciliacao.ResultadoOption.IsSet && conciliacao.Resultado == null)
                throw new ArgumentNullException(nameof(conciliacao.Resultado), "Property is required for class Conciliacao.");

            if (conciliacao.ResultadoOption.IsSet)
            {
                writer.WritePropertyName("resultado");
                JsonSerializer.Serialize(writer, conciliacao.Resultado, jsonSerializerOptions);
            }
        }
    }
}
