...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/poupanca-api.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{B70978CA-B944-4FFB-B2C8-F49AE7D1CD82}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAplicacaoPoupancaApi>();
            IAplicacaoApiResponse apiResponse = await api.AplicacaoAsync("todo");
            RetornoTransferencia? model = apiResponse.Ok();
        }
...
- appName: Poupança
- appVersion: 3.0.4.0
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/poupanca/v3 ]&lt;/pre&gt; # Poupança API Sistema que faz a gestão das contas de poupança através de transãções como Aplicação, Resgate, Saldo, Extrato e Controle de Rentabilidade. 
