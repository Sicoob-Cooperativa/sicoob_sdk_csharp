...
[assembly: InternalsVisibleTo("Sicoob.Poupanca.Test")]
...
namespace Sicoob.Poupanca.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is Transacao.TipoEnum transacaoTipoEnum)
                return Transacao.TipoEnumToJsonValue(transacaoTipoEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.sicoob.com.br/poupanca/v3";
        ...
        /// </summary>
        public const string CONTEXT_PATH = "/poupanca/v3";
