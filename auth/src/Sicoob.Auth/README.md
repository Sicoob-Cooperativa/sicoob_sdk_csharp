...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/autenticacao.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{B2326BC5-7166-4541-9B1D-61D15E83EF09}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAutenticaoApi>();
            IAuthRealmsCooperadoProtocolOpenidConnectTokenPostApiResponse apiResponse = await api.AuthRealmsCooperadoProtocolOpenidConnectTokenPostAsync("todo");
            AuthRealmsCooperadoProtocolOpenidConnectTokenPost200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Sicoob Autenticação
- appVersion: 1.0.0
- appDescription: API independente para geração de tokens de acesso mTLS via Client Credentials.
