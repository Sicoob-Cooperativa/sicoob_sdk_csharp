...
inputSpec: /home/naruto/Desktop/sicoob-sdks/swagger/spb-transferencias.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{FC1B7B10-B0EC-4737-B7A0-6274AB80A5C4}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<ITEDsApi>();
            ITransferenciasAgendamentosIdAgendamentoDeleteApiResponse apiResponse = await api.TransferenciasAgendamentosIdAgendamentoDeleteAsync("todo");
            TransferenciasAgendamentosIdAgendamentoDelete200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: SPB Transferências
- appVersion: 1.0.4.2
- appDescription: &lt;pre&gt;[ Base URL: https://api.sicoob.com.br/spb/v2 ]&lt;/pre&gt; A API tem como propósito fornecer serviços para envio de TEDs.
